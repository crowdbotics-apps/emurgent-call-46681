"""
Django settings for emurgent_call_46681 project.
...
ROOT_URLCONF = 'emurgent_call_46681.urls'
...
WSGI_APPLICATION = 'emurgent_call_46681.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "emurgent_call_46681 API",
    "DESCRIPTION": "API documentation for emurgent_call_46681 App",
    "VERSION": "v1",
}
